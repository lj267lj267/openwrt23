...
ifneq "$(KERNELVERSION)" "5.15.167"
include/config/auto.conf: FORCE
endif
ifneq "$(CC)" "mips-openwrt-linux-musl-gcc"
include/config/auto.conf: FORCE
endif
ifneq "$(LD)" "mips-openwrt-linux-musl-ld"
include/config/auto.conf: FORCE
endif
ifneq "$(srctree)" "."
include/config/auto.conf: FORCE
endif
ifneq "$(CC_VERSION_TEXT)" "mips-openwrt-linux-musl-gcc (OpenWrt GCC 12.3.0 r24106-10cc5fcd00) 12.3.0"
include/config/auto.conf: FORCE
endif
ifneq "$(NM)" "mips-openwrt-linux-musl-nm"
include/config/auto.conf: FORCE
endif
ifneq "$(OBJCOPY)" "mips-openwrt-linux-musl-objcopy"
include/config/auto.conf: FORCE
endif
ifneq "$(PAHOLE)" "pahole"
include/config/auto.conf: FORCE
...
ifneq "$(AR)" "mips-openwrt-linux-musl-ar"
include/config/auto.conf: FORCE
endif
