...
OUTPUT_ARCH(mips)
ENTRY(__start)
SEARCH_DIR("=/builder/shared-workdir/build/staging_dir/toolchain-mips_24kc_gcc-12.3.0_musl/mips-openwrt-linux-musl/lib32"); SEARCH_DIR("=/usr/local/lib32"); SEARCH_DIR("=/lib32"); SEARCH_DIR("=/usr/lib32"); SEARCH_DIR("=/builder/shared-workdir/build/staging_dir/toolchain-mips_24kc_gcc-12.3.0_musl/mips-openwrt-linux-musl/lib"); SEARCH_DIR("=/usr/local/lib"); SEARCH_DIR("=/lib"); SEARCH_DIR("=/usr/lib");
SECTIONS
{
